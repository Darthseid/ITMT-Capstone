...
<html lang="en" id="index">
  ...
  <body class="header-page  wsite-theme-light  wsite-page-index header-sticky banner-overlay-off reveal-content utils-hidden more-nav-on" data-gr-c-s-loaded="true" style="padding-top: 95px; min-height: 100%; position: relative; height: auto !important; padding-bottom: 62px !important;"><div class="wrapper">
		  ...
		  <div class="container">
			...
			<!-- Article 1(Huawei) -->
			  <h2 class="wsite-content-title" style="text-align:center;">
				  <a href="https://www.cnet.com/news/us-finds-huawei-has-backdoor-access-to-mobile-networks-globally-report-says/" target="_blank">
				   <font color="#3387a2">
					US finds Huawei has backdoor access to mobile networks globally.&#8203;
				   </font>
				  </a>
			  </h2>
			  <div class="wsite-image wsite-image-border-none " style="padding-top:0px;padding-bottom:0px;margin-left:0px;margin-right:0px;text-align:center">
				  <a>
				   <img src="../media/huawei.png" alt="Picture" style="width:auto;max-width:100%">
				  </a>
			  ...
			  <h2 class="wsite-content-title">Twitter rolls out new tool to combat misinformation about US census.&#8203;</h2>
						...
						<tr class="wsite-multicol-tr">
						  ...
						  <td class="wsite-multicol-col" style="width:33.333333333333%; padding:0 15px;">
							<div>
							  <div class="wsite-image wsite-image-border-none " style="padding-top:0px;padding-bottom:0px;margin-left:0px;margin-right:0px;text-align:center">
							   <a>
								<img src="../media/twitter.png" alt="Picture" style="width:auto;max-width:100%">
							   </a>
							   <div style="display:block;font-size:90%"></div>
							  </div>
							</div>
			  ...
			  <div>
				...
				<span style="display: table;width:459px;position:relative;float:left;max-width:100%;;clear:left;margin-top:0px;*margin-top:0px">
				  <a  href="https://threatpost.com/microsoft-active-attacks-air-gap-99-patches/152807/">
					<img src="../media/microsoft.jpg" style="margin-top: 10px; margin-bottom: 10px; margin-left: 0px; margin-right: 10px; border-width:0; max-width:100%" alt="Picture" class="galleryImageBorder wsite-image">
				  </a>
